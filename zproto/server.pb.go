...
func (x *AttachIn) GetServerId() string {
	if x != nil {
		return x.ServerId
	}
	return ""
...
var file_zproto_server_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x41, 0x0a, 0x08, 0x41, 0x74, 0x74, 0x61, 0x63, 0x68,
	0x49, 0x6e, 0x12, 0x1b, 0x0a, 0x09, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18,
	...
	0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x25, 0x0a, 0x09, 0x41, 0x74, 0x74,
	0x61, 0x63, 0x68, 0x4f, 0x75, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e,
	0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74,
	0x32, 0x87, 0x01, 0x0a, 0x06, 0x5a, 0x61, 0x6e, 0x64, 0x65, 0x72, 0x12, 0x48, 0x0a, 0x0b, 0x4c,
	...
	0x68, 0x4f, 0x75, 0x74, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x28, 0x5a, 0x26, 0x67, 0x69,
...
var file_zproto_server_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_zproto_server_proto_goTypes = []interface{}{
	...
	(*AttachIn)(nil),              // 3: zproto.AttachIn
	(*AttachOut)(nil),             // 4: zproto.AttachOut
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
}
var file_zproto_server_proto_depIdxs = []int32{
	2, // 0: zproto.ListServersResponse.servers:type_name -> zproto.Server
	5, // 1: zproto.Server.started_at:type_name -> google.protobuf.Timestamp
	0, // 2: zproto.Zander.ListServers:input_type -> zproto.ListServersRequest
	3, // 3: zproto.Zander.Attach:input_type -> zproto.AttachIn
	1, // 4: zproto.Zander.ListServers:output_type -> zproto.ListServersResponse
	4, // 5: zproto.Zander.Attach:output_type -> zproto.AttachOut
