...
namespace Zander.Modules.Settings.Engines {
    public class EngineViewModel : BaseViewModel {
        protected readonly ZanderConfigProvider configProvider;
        protected readonly IFileBrowserProvider fileBrowser;
        ...
        public EngineViewModel(ZanderConfigProvider configProvider, IFileBrowserProvider fileBrowser) {
